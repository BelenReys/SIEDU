var size = 0;
var placement = 'point';
function categories_Movilidaddepersonascondiscapacidad_19(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
var style_Movilidaddepersonascondiscapacidad_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("rango_");
    var labelText = "";
    size = 0;
...
var style = categories_Movilidaddepersonascondiscapacidad_19(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
