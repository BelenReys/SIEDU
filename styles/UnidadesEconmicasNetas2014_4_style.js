var size = 0;
var placement = 'point';
function categories_UnidadesEconmicasNetas2014_4(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '356 a MÃ¡s Unidades EconÃ³micas':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '271 a 355 Unidades EconÃ³micas':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '186 a 270 Unidades EconÃ³micas':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '101 a 185 Unidades EconÃ³micas':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '38 a 100 Unidades EconÃ³micas':
                    return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case '0 a 37 Unidades EconÃ³micas':
                    return [ new ol.style.Style({
...
var style_UnidadesEconmicasNetas2014_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_UnidadesEconmicasNetas2014_4(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
